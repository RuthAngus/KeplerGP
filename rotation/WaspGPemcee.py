...
if __name__ == "__main__":
    ...
    # load MOST data
    t, y, yerr = np.genfromtxt("/Users/angusr/Downloads/
                               267HIP1164542014reduced.dat").T[:,:t]
    ...
    # Run MCMC
    burn_in, nsteps = 1000, 5000
    MCMC(theta, x, y, yerr, fname, burn_in, nsteps)
